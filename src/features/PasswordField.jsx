import "../cssStyles/customPasswordField.css"
...
const InputPassword = ({
    ...
    const passStrength = useRef()
    const showPass = useRef()
    const [isShow, setIsShow] = useState(false)

    function passwordChanged({ target }) {
        updateForm({ target: target }) /* updates the originl form data*/
    ...
    function showPassword({ currentTarget }) {
        const inputField = currentTarget.parentNode.children[0]
        // const enableSvg = currentTarget.querySelector('.enable')
        // const disableSvg = currentTarget.querySelector('.disable')
    ...
    return (
        <div>
            <div className="input-field">
                ...
                />
                <span
                    className="show-password d-none"
                    title="show password"
                    ref={showPass}
            ...
            <div ref={passStrength} className="password-strength d-none">
                <span className="percent inverse-bg-color">
                    <span className="process"></span>
                </span>
                <span className="label text-color">Strength</span>
            </div>
        </div>
    )
}
